...
class WssClient:
    ...
    def reputations(self, comId, chatId: str, joinType: int = 1):
        """
        Start The Voice Chat
  ...
  "playlist":{"currentItemIndex":0,
              ...
              "items":[
                  {"author":"null",
                   ...
                   "isDone":False,
                   "mediaList":
                       [[100,"http://pm1.narvii.com/7841/fb192ede359a3ac5624f97d3ab7a80bc1b64badbr1-512-288v2_00.jpg","null"]],
                   "title":"test.mp4",
                   "type":1,
                   "url":"https://r1---sn-b5up3cn-cagl.googlevideo.com/videoplayback?expire=1613872508&ei=HGkxYNOUDtSi7gPAz4KYAg&ip=212.40.116.1&id=o-AI-oDZ8J9XnXcpAgThnPzRB0x28a2OmNK_v_bJvBoqP6&itag=18&source=youtube&requiressl=yes&vprv=1&mime=video%2Fmp4&ns=ft1jFRJz8ehnk8pR9vrlpQoF&gir=yes&clen=18505728&ratebypass=yes&dur=199.598&lmt=1575018161425450&fvip=6&c=WEB&txp=3531432&n=ILDYjj0wMT0ZZ-cD&sparams=expire%2Cei%2Cip%2Cid%2Citag%2Csource%2Crequiressl%2Cvprv%2Cmime%2Cns%2Cgir%2Cclen%2Cratebypass%2Cdur%2Clmt&sig=AOq0QJ8wRQIhAOtDlztiTokj0qR4aykEvLB-sBbXTVmxuxkLA5I_OhQVAiAYLS1TpLinRMIuxfnfmc-yIbD-PKEiU4P85sRd657kqQ==&title=ITZY+%22ICY%22+M%2FV&cms_redirect=yes&mh=MH&mip=103.224.38.152&mm=31&mn=sn-b5up3cn-cagl&ms=au&mt=1613851956&mv=m&mvi=1&pl=24&lsparams=mh,mip,mm,mn,ms,mv,mvi,pl&lsig=AG3C_xAwRQIhALXXHfBT94zuRuNDqmD-4MBaoE5rF1YdoWL14uNfIZwIAiBa6LU_7KcyM7oGo8fbMybM2y61apjnHQIearss7d57tQ%3D%3D"}]},
      "id":"244360"},"t":120}
        self.wss.send(data)
